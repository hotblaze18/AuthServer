...
describe('UserService', () => {
  ...
  it('deleteUser_UserNotExist_throwEntityNotFoundError', async () => {
    const functionUnderTest = () => service.deleteUser(transactionRunner, 12);
